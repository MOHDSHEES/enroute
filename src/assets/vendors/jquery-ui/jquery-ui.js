...
*/
  ...
  $.extend(Datepicker.prototype, {
    ...
    _generateHTML: function (inst) {
      ...
      prev = this._canAdjustMonth(inst, -1, drawYear, drawMonth)
        ? "<Link className='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click'" +
          " title='" +
          prevText +
        ...
        : hideIfNoPrevNext
        ? ""
        : "<Link className='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" +
          prevText +
          "'><span className='ui-icon ui-icon-circle-triangle-" +
          (isRTL ? "e" : "w") +
          "'>" +
      ...
      next = this._canAdjustMonth(inst, +1, drawYear, drawMonth)
        ? "<Link className='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click'" +
          " title='" +
          nextText +
          "'><span className='ui-icon ui-icon-circle-triangle-" +
          (isRTL ? "w" : "e") +
        ...
        : hideIfNoPrevNext
        ? ""
        : "<Link className='ui-datepicker-next ui-corner-all ui-state-disabled' title='" +
          nextText +
          "'><span className='ui-icon ui-icon-circle-triangle-" +
          (isRTL ? "w" : "e") +
          "'>" +
  ...
  var spinner = $.widget("ui.spinner", {
    ...
    _buttonHtml: function () {
      return (
        "" +
        "<Link className='ui-spinner-button ui-spinner-up ui-corner-tr'>" +
        "<span className='ui-icon " +
        this.options.icons.up +
        "'>&#9650;</span>" +
        "</Link>" +
        "<Link className='ui-spinner-button ui-spinner-down ui-corner-br'>" +
        "<span className='ui-icon " +

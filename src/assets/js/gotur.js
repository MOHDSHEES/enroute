      ...
      Self.ajaxChimp({
        ...
        callback: function (resp) {
          ...
          mcResp.append(function () {
            return '<p className="mc-message">' + resp.msg + "</p>";
          });
      ...
      goturowlCarouselWithCounter.each(function () {
        ...
        elm
          .on("initialized.owl.carousel", function (event) {
            ...
            elm.append(
              '<div className="gotur-owl__carousel__counter"><span className="gotur-owl__carousel__counter__total"></span> <span className="gotur-owl__carousel__counter__current"></span></div>'
            );
            elm
    ...
    if ($(".price-ranger-two").length) {
      $("#slider-range-two").slider({
        ...
        create: function( event, ui ) {
          $('.price-ranger-two').find('.ui-slider-handle').append("<span className='value'></span>");
          $('.price-ranger-two').find('.ui-slider-handle').append("<span className='value-two'></span>");
  ...
  function scrollTopPercentage() {
    const scrollPercentage = () => {
      ...
      if (scrollValue < 96) {
        ...
        $("#scroll-top-value").html('<i className="fas fa-arrow-up"></i>');
      }
    };

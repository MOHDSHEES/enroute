...
const sidebarData = {
  logo: logo,
  subtitle: "We’re Number One Travel Adventure Company",
  description:
  ...
  contactItems: [
    {
      icon: "icon-email",
      title: "Send email",
      content: "enroutetrips04@gmail.com",
      href: "mailto:enroutetrips04@gmail.com",
    },
    {
      icon: "icon-telephone",
      title: "Call agent",
  ...
  newsletterActionUrl:
    "//xxxx.us13.list-manage.com/subscribe/post?u=zefzefzef&id=fnfgn", // Replace with your Mailchimp URL
};

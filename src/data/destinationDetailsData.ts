let sliderImage1 = "backgrounds/destination-slider-1-1.jpg";
let sliderImage2 = "backgrounds/destination-slider-1-2.jpg";
let sliderImage3 = "backgrounds/destination-slider-1-3.jpg";
let sliderImage4 = "backgrounds/destination-slider-1-4.jpg";
let img1 = "destination/destination-d-s-1.jpg";
let img2 = "destination/destination-d-s-2.jpg";

const destinationDetailsData = {
  title: "Overview",
  titleTwo: "Top Destinations",
  overview:
...
export default destinationDetailsData;

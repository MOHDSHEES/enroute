    ...
    return (
        <section className="error-404 section-space">
            <Container>
                ...
                <img src={shape1} alt="error image" />
                    </div>
                    <div className="error-404__element-two">
                    <img src={shape2} alt="error image" />
                    </div>
                </div>
                ...
                <div className="error-404__btns wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="600ms" >
                    <Link to="/" className="gotur-btn gotur-btn--primary error-404__btn">Back to Home Pages <span className="icon"><i className="icon-right"></i></span></Link>
                </div>
            </Container>
        </section>

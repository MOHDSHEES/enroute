    ...
    <>
      <section className='about-five section-space' id='about'>
            ...
            <Col lg={5}>
              ...
              >
                <div className='about-five__thumb__item'>
                  <DynamicImage src={mainImage} alt='thumb item' />
                </div>
                <div className='about-five__thumb__item-small'>
                  <DynamicImage src={smallImage} alt='small thumb item' />
                </div>
                ...
                <div className='about-five__thumb__item-element'>
                  <DynamicImage src={shapeOverlay} alt='shape overlay' />
                </div>
              </div>
            </Col>
            <Col lg={7}>
              <div className='about-five__right'>
                ...
                <div
                  ...
                  data-wow-delay='300ms'
                >
                  <Link to={buttonUrl} className='gotur-btn gotur-btn--primary'>
                    {buttonText}{" "}
                    <span className='icon'>
                  ...
                  <div className='about-two__button__author'>
                    <div className='about-two__button__author__thumb'>
                      <DynamicImage src={authorImage} alt='author' />
                    </div>
        ...
        <div className='about-five__element-one'>
          <DynamicImage src={shapeOne} alt='shape 1' />
        </div>
        <div className='about-five__element-two'>
          <DynamicImage src={shapeTwo} alt='shape 2' />
        </div>
      </section>

...
const ProductsListRight: React.FC = () => {
            ...
            <Row className="gutter-y-30">
              {products.map((product: Product, index: number) => (
                <Col xs={12} key={product.id}>
                  <div
                    className="product-list__item wow fadeInUp"
                    ...
                    <Row className="align-items-center gutter-y-30">
                      ...
                      <Col md={8}>
                        <div className="product-list__item__content">
                          ...
                          <p className="product-list__item__text">
                            Lorem ipsum dolor sit amet consectetur. Nunc sit
                            morbi turpis sed volutpat egestas. Mollis
                            scelerisque a sem morbi sed donec eu.
                          </p>
...
export default ProductsListRight;

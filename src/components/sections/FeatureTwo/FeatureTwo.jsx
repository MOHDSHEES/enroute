...
const FeatureTwo = ({ trending, extraClass, id }) => {
  ...
  // Move settings to a constant to keep the JSX clean
      ...
      >
        ...
        <div className="container-fluid">
          <div className="feature-package__inner">
            {/* 1. Removed PhotoSwipeGallery from here to prevent DOM conflicts */}
            <div className="feature-package__carousel">
              {trending && trending.length > 0 ? (
                <TinySlider settings={sliderSettings}>
                  {trending.map((item) => (
                    /* 2. Wrap the component in a plain div so Tiny Slider has a stable DOM node */

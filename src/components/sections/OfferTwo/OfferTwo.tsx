    ...
    <section className="offer-two section-space-bottom" ref={ref}>
      <div className="container">
        <div className="offer-two__inner">
          <Row>
            <Col lg={8} xl={6}>
              <div className="offer-two__content">
                ...
                >
                  <Link to={buttonLink} className="gotur-btn">
                    {buttonText}{" "}
                    <span className="icon">
          ...
          >
            <div
              className="offer-two__thumb__item offer-two__thumb__item"
              style={{ width: "489px", height: "652px" }}
            >
              <DynamicImage src={image} alt="offer image" />
            </div>
            ...
            <div className="offer-two__funfact__item">
              <div className="offer-two__funfact__item__inner count-box">
                ...
                <div className="offer-two__funfact__item__shape">
                  <DynamicImage src={shapes.shape1} alt="shape" />
                </div>
              </div>
            </div>
          ...
          <div className="offer-two__element">
            <DynamicImage src={shapes.bgShape} alt="background shape" />
          </div>
          <div className="offer-two__element-two">
            <DynamicImage src={shapes.aboutShape} alt="about shape" />
          </div>
          <div className="offer-two__element-three">
            <DynamicImage src={shapes.planShape} alt="plan shape" />
          </div>
        </div>
      </div>
    </section>

    ...
    <footer className="main-footer">
        ...
        <Container>
          ...
          >
            <div className="footer-widget__logo logo-retina">
              <Link to="/">
                <DynamicImage src={data.logo} alt="gotur logo" />
              </Link>
            </div>
            <ul className="list-unstyled footer-widget__list">
              <li>
                ...
                <div className="footer-widget__list__content">
                  ...
                  <Link to={`mailto:${data.contact.email}`}>
                    {data.contact.email}
                  </Link>
                </div>
              </li>
              <li>
                ...
                <div className="footer-widget__list__content">
                  ...
                  <Link to={`tel:${data.contact.phone}`}>
                    {data.contact.phone}
                  </Link>
                </div>
              </li>
      ...
      <div className="main-footer__middle">
                      ...
                      <div className="mc-form">
                        ...
                        >
                          ...
                          <div className="form-group__check">
                            ...
                            <label htmlFor="check">
                              I agree to the{" "}
                              <a href={data.newsletter.privacyLink}>
                                Privacy Policy.
                              </a>
                            </label>
                          </div>
        ...
        <div className="main-footer__element-one">
          <DynamicImage src={data.shape1} alt="footer shape" />
        </div>
        <div className="main-footer__element-two">
          <DynamicImage src={data.shape2} alt="footer shape" />
        </div>
      </div>
        ...
        <Container>
          <div className="main-footer__bottom__inner">
            ...
            {/* <div className="main-footer__bottom__pyment">
              <Link to="/checkout">
                <DynamicImage src={data.cardImage} alt="gotur payment" />
              </Link>
            </div> */}
          </div>
        </Container>
